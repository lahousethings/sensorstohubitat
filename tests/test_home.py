...
class HomeTest(BaseCase,Keys):
    ...
    def test_pool_temperature(self):
        ...
        for index, pool_number in enumerate(pool_numbers, 1):
            poollist.append(pool_number.text.replace(",", "."))

        #Send Numbers to Hubitat
        self.open_url("http://192.168.90.254/apps/api/1241/devices/7041/setTemperature/"+poollist[1]+"?access_token=d1303322-7a9c-474a-a385-b37ef32b2103")
        self.open_url("http://192.168.90.254/apps/api/1241/devices/7048/setTemperature/"+poollist[2]+"?access_token=d1303322-7a9c-474a-a385-b37ef32b2103")
        self.open_url("http://192.168.90.254/apps/api/1241/devices/7049/setTemperature/"+poollist[3]+"?access_token=d1303322-7a9c-474a-a385-b37ef32b2103")
        self.open_url("http://192.168.90.254/apps/api/1241/devices/7046/setTemperature/"+poollist[6]+"?access_token=d1303322-7a9c-474a-a385-b37ef32b2103")
        self.open_url("http://192.168.90.254/apps/api/1241/devices/7047/setTemperature/"+poollist[7]+"?access_token=d1303322-7a9c-474a-a385-b37ef32b2103")
